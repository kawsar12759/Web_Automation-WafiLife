...
//    };
    ...
    public By getCategorySection(int categoryNum){
        return By.xpath("//div[@class='wafi_products']["+(categoryNum+1)+"]");
    }

    public By getCategorySectionHeading(int categoryNum) {
        return By.xpath("//div[@class='wafi_products']["+categoryNum+"]//h3[@class='heading-title']");
    }
    public By getCategorySectionButton(int categoryNum) {
        return By.xpath("//div[@class='wafi_products']["+categoryNum+"]//div[@class='load-more-button']//a");
    }
    public By getCategoryActiveFirstProduct(int categoryNum){
        return By.xpath("//div[@class='wafi_products']["+categoryNum+"]//div[@class='owl-stage-outer']//div[contains(@class,'owl-stage')]//div[@class='owl-item active'][1]");
    }
    public By getCategoryActiveFirstProductTitle(int categoryNum) {
        return By.xpath("//div[@class='wafi_products'][" + categoryNum + "]//div[@class='owl-stage-outer']//div[contains(@class,'owl-stage')]//div[@class='owl-item active'][1]//li[1]//div[@class='product_item_wrapper']//div[@class='product-meta-wrapper']//h3");
    }
    public By getCategoryActiveFirstProductAuthor(int categoryNum) {
        return By.xpath("//div[@class='wafi_products'][" + categoryNum + "]//div[@class='owl-stage-outer']//div[contains(@class,'owl-stage')]//div[@class='owl-item active'][1]//li[1]//div[@class='product_item_wrapper']//div[@class='product-meta-wrapper']//div//a");
    }
    public By getCategoryActiveFirstProductPrice(int categoryNum) {
        return By.xpath("//div[@class='wafi_products']["+categoryNum+"]//div[@class='owl-stage-outer']//div[contains(@class,'owl-stage')]//div[@class='owl-item active'][1]//li[1]//div[@class='product_item_wrapper']//div[@class='product-meta-wrapper']//span[@class='price']//ins");
    }
    public By getCategorySectionNextButton(int categoryNum) {
        return By.xpath("//div[@class='wafi_products'][" + categoryNum + "]//div[@class='custom-nav-button-container']//a[@title='next']");
    }
    public By getCategorySectionPrevButton(int categoryNum) {
        return By.xpath("//div[@class='wafi_products'][" + categoryNum + "]//div[@class='custom-nav-button-container']//a[@title='prev']");
    }

    public By categorySubPageTitle = By.xpath("//h1[@class='heading-title page-title']");

    public By firstProductDetailsTitle = By.cssSelector(".product_title.entry-title");
    public By firstProductDetailsAuthor = By.xpath("//div[@class='summary entry-summary']//a");

//    public By numberOfTotalBooks = By.xpath("//span[@class='infor']");
}
